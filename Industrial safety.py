...
cap.set(3, 1280)
cap.set(4, 720)
# cap = cv2.VideoCapture(r"C:\Users\ad920\Documents\VS CODE\CODES IN PYTHON\Major Project\Input\tyt.mp4")  # For Video
 
# model = YOLO("ppe.pt")
model = YOLO(r"C:\Users\ad920\Downloads\Major Project-20260224T053526Z-1-001\Major Project\The Project\best.pt")
